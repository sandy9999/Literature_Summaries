...
%\usepackage{layout}
\clearpage
\mytitle{ACORN: Input Validation for Secure Aggregation \large \\Paper Summary}
...
\section{Summary}
\underline{Problem Statement}: Consider $S$ servers, i-th server has a private value $x_i$. The servers want to collectively learn the $\sum_{i \in S}\overline
